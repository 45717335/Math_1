...
Function sizeyunsuan(Optional op1 As String = "", Optional op2 As String = "") As String
    ...
    If op1 = "¼Ó" Then op1 = JIA
    If op1 = "¼õ" Then op1 = JIAN
    If op1 = "³Ë" Then op1 = CHENG
    If op1 = "³ý" Then op1 = CHU
    If op2 = "¼Ó" Then op2 = JIA
    If op2 = "¼õ" Then op2 = JIAN
    If op2 = "³Ë" Then op2 = CHENG
    If op2 = "³ý" Then op2 = CHU
    If op1 = "³ýÒÔ" Then op2 = CHU
    If op2 = "³ýÒÔ" Then op2 = CHU
    b_c = True
    Do While b_c
        i1 = Int(Rnd() * 99 + 1)
        i2 = Int(Rnd() * 99 + 1)
